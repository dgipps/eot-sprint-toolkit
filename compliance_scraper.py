...
"55141 - Wood County",
"Any   - West Virginia - all counties",
...
def main():
    for state_string in state_array:
        download_state_csv(state_string[:2])
